...
red = redis.Redis(host ='192.168.34.236', db =0)

me = "amit.singh2@timesinternet.in"
to = ["asheesh.mahor@timesinternet.in","saurabh.chandolia@timesinternet.in","amit.singh2@timesinternet.in","kundan.kumar1@timesinternet.in","gaurav.sharma8@timesinternet.in"]
