...
def get_tokens_nlp(doc, stemmer, lang="en"):
    ret = []
    skip_tokens = {
        "en": ["are", "do", "'s", "be", "is", "https//", "#", "-pron-", "so", "as", "that", "not", "who", "which",
               "thing", "even", "said", "says", "say", "keep", "like", "will", "have", "what", "can", "how", "get",
               "there", "would", "when", "then", "here", "other", "know", "let", "all"],
        "sv": ["t", "s", "o", "#", "m", "2", "c", "1", "3", "4", "03", "000", "a", "in", "ta", "nr", "se", "fö", "få",
               "ge", "30", "ska", "vill", "kommer", "bara", "får", "finns", "gör", "går", "helt", "väl", "också",
               "även", "borde", "hela", "dom", "alltså", "kanske", "gå", "sitt", "nog", "genom", "skall", "annat",
               "kunna", "sätt", "ens", "just", "bör", "ändå", "sen", "både", "vore", "därför", "ännu", "pga", "får",
               "gör", "få", "går", "tycker", "väl", "tror", "ser", "lite", "göra", "också", "även", "tar", "vet",
               "behöver", "två", "alltså", "igen", "står", "verkar", "redan", "gå", "dags", "inför", "håller", "lika",
               "fram", "del", "enligt", "ger", "verkligen", "säga", "sätt", "visar", "gäller", "undrar", "bör", "ändå",
               "all", "gång", "förstår", "kom", "gjort", "fick", "fått", "handlar", "sagt", "vissa", "både", "därför",
               "precis", "riktigt", "ännu", "väldigt", "hos", "samtidigt", "sitter", "menar", "komma", "låter", "låt",
               "hålla", "egen", "sak", "stå", "hej", "nästa"],
        "fi": []}
    for token in doc:
        lemma = token.lemma_
        pos = token.pos_
...
def get_freq_dist(tag_map, lang="en"):
    skip_tokens = {
        "en": ["just", "think", "how", "need", "only", "all", "still", "even", "why", "look", "let", "most", "way",
               "more", "mean", "new", "must", "talk", "try", "back", "have", "seem", "will", "see", "use", "tell",
               "would", "should", "could", "can", "go", "are", "do", "'s", "be", "make", "want", "know", "come", "is",
               "https//", "#", "-pron-", "when", "here", "say", "there", "also", "quite", "so", "get", "perhaps", "as",
               "that", "now", "not", "then", "who", "very", "which", "then", "thing", "what", "take", "give", "show",
               "really", "keep", "other", "people", "man"],
        "sv": ["t", "s", "o", "#", "m", "2", "c", "1", "3", "4", "03", "000", "a", "in", "ta", "nr", "se", "fö", "få",
               "ge", "30", "ska", "vill", "kommer", "bara", "får", "finns", "gör", "går", "helt", "väl", "också",
               "även", "borde", "hela", "dom", "alltså", "kanske", "gå", "sitt", "nog", "genom", "skall", "annat",
               "kunna", "sätt", "ens", "just", "bör", "ändå", "sen", "både", "vore", "därför", "ännu", "pga", "får",
