...
if __name__ == '__main__':
    ...
    consumer = KafkaConsumer(topic_name, bootstrap_servers=['localhost:9092'],
                             ...
                             auto_commit_interval_ms=1000, consumer_timeout_ms=5000, group_id=None)
    # print(consumer,dir(consumer))
    # print(consumer.topics(),consumer.partitions_for_topic(topic_name))
    for msg in consumer:
        # print(msg)
        html = msg.value
        result = parse(html)
        producer = connect_kafka_producer()
        publish_message(producer, parsed_topic_name, 'parsed', result)
