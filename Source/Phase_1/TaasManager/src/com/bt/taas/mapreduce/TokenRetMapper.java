 ...
 *
 */
public class TokenRetMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
	...
	protected void setup(Context context) throws IOException, InterruptedException {
		...
		postfix = context.getConfiguration().get("postfix");
		...
		try {
			for (Integer li : index) {
				if (!("".equalsIgnoreCase(str[li]) || "null".equalsIgnoreCase(str[li])
					...
					String tokenizedval = tokenret.getTokenizeValue(authkey, str[li], prefix, postfix);
